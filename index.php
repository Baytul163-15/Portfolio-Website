<?php 
    ...
    #Display_All_NewsFeed_Post
    $post = $obj_client->display_all_post_index();

    #Pagignation
    $page = $obj_client->post_pagination_number_index();
?>
<div id="main-content">
        <div class="container">
            <div class="row">
                    ...
                    <div class="post-container">
                        ...
                        <?php } ?>
                            <?php
                                ...
                                if ($page_number > 1) {
                                    echo '<li><a href="index.php?page='.($page_number-1).'">pre</a></li>';
                                }
                                for ($i = 1; $i <= $page; $i++) { 
                                    if ($i == $page_number) {
                                    $active = "active";
